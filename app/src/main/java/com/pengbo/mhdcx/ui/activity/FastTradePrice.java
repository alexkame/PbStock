 ...
 *
 */
public class FastTradePrice extends BaseActivity implements OnItemClickListener,OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPriceType = this.getIntent().getIntExtra(SettingActivity.INTENT_KJFSTYPE, Trade_Define.WTPRICEMODE_DSJ);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		PreferenceEngine.getInstance().saveTradeKJFSWTPrice(priceTypes[mSelectIndex]);
		Intent intent = new Intent();
		intent.putExtra(SettingActivity.INTENT_KJFSTYPE, mPriceType);
		setResult(RESULT_CODE_FastPrice, intent);		
		FastTradePrice.this.finish();	
	}
