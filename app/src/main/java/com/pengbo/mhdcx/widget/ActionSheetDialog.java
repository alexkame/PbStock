...
public class ActionSheetDialog {
	...
	public ActionSheetDialog setSubTitle(String subtitle) {
	...
	public ActionSheetDialog addSheetItem(String strItem, SheetItemColor color,
			OnSheetItemClickListener listener, boolean isEnabled) {
		if (sheetItemList == null) {
			sheetItemList = new ArrayList<SheetItem>();
		}
		sheetItemList.add(new SheetItem(strItem, color, listener, isEnabled));
		return this;
	}
	...
	private void setSheetItems() {
		...
		for (int i = 1; i <= size; i++) {
			...
			boolean isEnabled = sheetItem.isEnabled;
	...
	public class SheetItem {
		...
		public SheetItem(String name, SheetItemColor color,
				OnSheetItemClickListener itemClickListener, boolean isEnabled) {
			this.name = name;
			this.color = color;
