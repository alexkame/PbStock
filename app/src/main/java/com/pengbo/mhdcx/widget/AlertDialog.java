...
public class AlertDialog {
	...
	public AlertDialog builder() {
		...
		txt_optionnamevalue = (TextView) view.findViewById(R.id.txt_optionnamevalue);
		...
		txt_optioncodevalue = (TextView) view.findViewById(R.id.txt_optioncodevalue);
		...
		txt_optionname_fs = (TextView) view.findViewById(R.id.txt_optionname_fs);
		txt_optionname_fs.setVisibility(View.GONE);
		txt_optionnamevalue_fs = (TextView) view.findViewById(R.id.txt_optionnamevalue_fs);
		txt_optionnamevalue_fs.setVisibility(View.GONE);
		txt_optioncode_fs = (TextView) view.findViewById(R.id.txt_optioncode_fs);
		txt_optioncode_fs.setVisibility(View.GONE);
		txt_optioncodevalue_fs = (TextView) view.findViewById(R.id.txt_optioncodevalue_fs);
