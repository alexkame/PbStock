package com.pengbo.mhdcx.wheel.widget;
...
import com.pengbo.mhdcx.wheel.widget.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// #0xFF111111 0xFF111111, 0x00AAAAAA, 0x00AAAAAA
	...
	private void drawItems(Canvas canvas) {
		...
		if ((currentItem - firstItem) < itemsLayout.getChildCount() && (currentItem - firstItem)>=0)
		{
			TextView tv = (TextView)itemsLayout.getChildAt(currentItem - firstItem).findViewById(R.id.keyboard_kjbj_name);
			tv.setTextColor(ColorConstant.COLOR_ALL_BLUE);
		}
	...
	private void doScroll(int delta) {
		...
		{
			TextView tv = (TextView)itemsLayout.getChildAt(currentItem - firstItem).findViewById(R.id.keyboard_kjbj_name);
			tv.setTextColor(ColorConstant.COLOR_KEYBOARD_PRICE);
		}
