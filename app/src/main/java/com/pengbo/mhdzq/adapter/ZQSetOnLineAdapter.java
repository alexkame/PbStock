...
public class ZQSetOnLineAdapter extends BaseAdapter{
	...
	public ZQSetOnLineAdapter(List<String> datas,Context con) {
		this.datas=datas;
		this.context=con;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		View view=View.inflate(context, R.layout.zq_set_online_listview_item, null);
