...
public class HomeEditFixedListAdapter extends BaseAdapter {

	private ArrayList<DBZQHomeActivityMarket> datas;

	private LayoutInflater mInflater;

	private Context context;

	public HomeEditFixedListAdapter(Context con, ArrayList<DBZQHomeActivityMarket> datas) {
		super();
		this.datas = datas;
	...
	public View getView(final int position, View convertView, ViewGroup parentView) {
		...
		DBZQHomeActivityMarket item = datas.get(position);
		...
		viewHolder.tv_market_name.setEnabled(false);
			...
			viewHolder.tv_market_name.setCompoundDrawables(drawable, null, null, null);
