package com.pengbo.mhdzq.common;
...
public class StringUtils {
	...
	public static String fromDB(String in) {
		...
		do {
			...
			if (-1 != j && -1 != k) {
				...
				int i_number = STD.StringToInt(number);
	...
	/**
	 * @param localVersion 安装的apk版本号
	 * @param remoteVersion 版本服务器上的版本号
	 * @return <0需要更新
	 */
	public static int compareVersion(String localVersion, String remoteVersion) {
		return 0;
		/**
		 * if (ValidateUtils.isVersion(localVersion) && ValidateUtils.isVersion(remoteVersion)) {
